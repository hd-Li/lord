...
type GatewayHandlerFunc func(key string, obj *v1alpha3.Gateway) (runtime.Object, error)

type GatewayChangeHandlerFunc func(obj *v1alpha3.Gateway) (runtime.Object, error)

type GatewayLister interface {
	List(namespace string, selector labels.Selector) (ret []*v1alpha3.Gateway, err error)
...
type GatewayInterface interface {
	...
	GetNamespaced(namespace, name string, opts metav1.GetOptions) (*v1alpha3.Gateway, error)
	Get(name string, opts metav1.GetOptions) (*v1alpha3.Gateway, error)
...
func (l *gatewayLister) List(namespace string, selector labels.Selector) (ret []*v1alpha3.Gateway, err error) {
	err = cache.ListAllByNamespace(l.controller.Informer().GetIndexer(), namespace, selector, func(obj interface{}) {
		ret = append(ret, obj.(*v1alpha3.Gateway))
	})
	return
}

func (l *gatewayLister) Get(namespace, name string) (*v1alpha3.Gateway, error) {
	var key string
	if namespace != "" {
		key = namespace + "/" + name
	} else {
...
func (c *gatewayController) AddHandler(ctx context.Context, name string, handler GatewayHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		...
		} else if v, ok := obj.(*v1alpha3.Gateway); ok {
...
func (c *gatewayController) AddClusterScopedHandler(ctx context.Context, name, cluster string, handler GatewayHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if obj == nil {
			return handler(key, nil)
		} else if v, ok := obj.(*v1alpha3.Gateway); ok && controller.ObjectInCluster(cluster, obj) {
			return handler(key, v)
		} else {
			return nil, nil
		}
...
func (s *gatewayClient) Create(o *v1alpha3.Gateway) (*v1alpha3.Gateway, error) {
	obj, err := s.objectClient.Create(o)
	return obj.(*v1alpha3.Gateway), err
}

func (s *gatewayClient) Get(name string, opts metav1.GetOptions) (*v1alpha3.Gateway, error) {
	obj, err := s.objectClient.Get(name, opts)
	return obj.(*v1alpha3.Gateway), err
}

func (s *gatewayClient) GetNamespaced(namespace, name string, opts metav1.GetOptions) (*v1alpha3.Gateway, error) {
	obj, err := s.objectClient.GetNamespaced(namespace, name, opts)
	return obj.(*v1alpha3.Gateway), err
}

func (s *gatewayClient) Update(o *v1alpha3.Gateway) (*v1alpha3.Gateway, error) {
...
type GatewayClientCache interface {
	...
	GetIndexed(name, key string) ([]*v1alpha3.Gateway, error)
}

type GatewayClient interface {
	Create(*v1alpha3.Gateway) (*v1alpha3.Gateway, error)
	Get(namespace, name string, opts metav1.GetOptions) (*v1alpha3.Gateway, error)
	Update(*v1alpha3.Gateway) (*v1alpha3.Gateway, error)
...
func (n *gatewayClient2) Create(obj *v1alpha3.Gateway) (*v1alpha3.Gateway, error) {
	return n.iface.Create(obj)
}

func (n *gatewayClient2) Get(namespace, name string, opts metav1.GetOptions) (*v1alpha3.Gateway, error) {
	return n.iface.GetNamespaced(namespace, name, opts)
}

func (n *gatewayClient2) Update(obj *v1alpha3.Gateway) (*v1alpha3.Gateway, error) {
...
func (n *gatewayClientCache) Get(namespace, name string) (*v1alpha3.Gateway, error) {
	return n.client.controller.Lister().Get(namespace, name)
}

func (n *gatewayClientCache) List(namespace string, selector labels.Selector) ([]*v1alpha3.Gateway, error) {
...
func (n *gatewayClientCache) Index(name string, indexer GatewayIndexer) {
	err := n.client.controller.Informer().GetIndexer().AddIndexers(map[string]cache.IndexFunc{
		name: func(obj interface{}) ([]string, error) {
			if v, ok := obj.(*v1alpha3.Gateway); ok {
				return indexer(v)
			}
			return nil, nil
		},
...
func (n *gatewayClientCache) GetIndexed(name, key string) ([]*v1alpha3.Gateway, error) {
	var result []*v1alpha3.Gateway
...
func (n *gatewayLifecycleDelegate) Create(obj *v1alpha3.Gateway) (runtime.Object, error) {
	if n.create == nil {
		return obj, nil
	}
	return n.create(obj)
...
func (n *gatewayLifecycleDelegate) Remove(obj *v1alpha3.Gateway) (runtime.Object, error) {
	if n.remove == nil {
		return obj, nil
	}
	return n.remove(obj)
...
func (n *gatewayLifecycleDelegate) Updated(obj *v1alpha3.Gateway) (runtime.Object, error) {
	if n.update == nil {
		return obj, nil
	}
	return n.update(obj)
